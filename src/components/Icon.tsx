...
const ICONS: Record<string, Prim[]> = {
  ...
  'eye-off': [
    ...
    { p: 'M10.73 5.08A10.43 10.43 0 0 1 12 5c6.5 0 10 7 10 7a13.2 13.2 0 0 1-1.67 2.68' },
    { p: 'M6.61 6.61A13.5 13.5 0 0 0 2 12s3.5 7 10 7a9.7 9.7 0 0 0 5.39-1.61' },
    { p: 'M2 2l20 20' },
  ],
};
